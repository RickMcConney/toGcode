        ...
        gcodeProfiles = [
            {
                ...
                spindleOnGcode: 'M3 S',
                spindleOffGcode: 'M5',
                cwArcTemplate: 'G2 X Y Z I J F',
                ccwArcTemplate: 'G3 X Y Z I J F',
                useArcs: false,
                commentChar: '(',
...
function createNewGcodeProfile() {
    ...
    const handleConfirm = function () {
        ...
        const newProfile = {
            ...
            cwArcTemplate: currentGcodeProfile ? (currentGcodeProfile.cwArcTemplate || 'G2 X Y Z I J F') : 'G2 X Y Z I J F',
            ccwArcTemplate: currentGcodeProfile ? (currentGcodeProfile.ccwArcTemplate || 'G3 X Y Z I J F') : 'G3 X Y Z I J F',
